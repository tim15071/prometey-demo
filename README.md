...
Раздел «Камеры» поддерживает публичные HLS-трансляции после подключения видеосервера. В начальной конфигурации поток не задан. Контакты, документы, новости и камеры редактируются через Pages CMS. Пароли камер, RTSP-ссылки с паролями и облачные ID в публичное хранилище не добавляются.
